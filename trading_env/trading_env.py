...
class CryptoTradingEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # print("==self.data['Balance'][t]==", self.data['Balance'][t])
    ...
    def plot(self, lable = "close", legend="Price"):
        ...
        print(self.data.loc[self.data['Action'] == 1].index)

        ax.plot(self.data[lable].index, self.data[lable])
        ax.plot(self.data.loc[self.data['Action'] == 1].index, 
                    self.data[lable][self.data['Action'] == 1],
